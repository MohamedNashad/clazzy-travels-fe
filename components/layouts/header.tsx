...
import { toggleTheme, toggleSidebar, toggleRTL } from '@/store/theme-config-slice';
...
import LogoutButton from '../molecules/logout-button/logout-button';
...
const Header = () => {
    ...
    const isRtl = useSelector((state: IRootState) => state.themeConfigReducer.rtlClass) === 'rtl';
                ...
                <div className="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex items-center justify-between lg:hidden ltr:mr-2 rtl:ml-2">
                        <Link href="/" className="main-logo flex shrink-0 items-center">
                            ...
                            <span className="hidden align-middle text-2xl  font-semibold  transition-all duration-300 dark:text-white-light md:inline ltr:ml-1.5 rtl:mr-1.5">CLAZZY TR</span>
                        </Link>
                        <button
                            type="button"
